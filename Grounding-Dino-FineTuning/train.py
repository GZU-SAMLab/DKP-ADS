...
def train(model, ann_file, epochs=1, save_path='weights_allkinds/model_weights',save_epoch=50):
    # Read Dataset
...
if __name__=="__main__":
    train(model=model, ann_file=ann_file, epochs=2000, save_path='weights_allkinds/model_weights')